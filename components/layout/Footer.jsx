      ...
      <div className="container mx-auto py-12 px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            <h3 className="font-bold text-2xl mb-4">
              <span className="text-blue-400">PARAMOUNT</span> <span className="text-amber-400">ENERGY</span>
            </h3>
            <p className="mb-4 text-slate-300">
              Providing reliable and innovative electrical solutions for residential, commercial, and industrial clients across Sydney since 2005.
            </p>
          ...
          {/* Contact Info */}
          <div>
            <h3 className="text-lg font-bold mb-4 border-b border-slate-700 pb-2">Contact Us</h3>
            <div className="space-y-4">
              ...
              <div className="flex items-center">
                ...
                <p className="text-slate-300">info@paramountenergy.com.au</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-slate-700 mt-10 pt-6 text-center md:flex md:justify-between md:text-left">
          <p className="text-slate-400">
            &copy; {new Date().getFullYear()} Paramount Energy Group. All rights reserved.
          </p>
