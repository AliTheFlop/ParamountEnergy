            ...
            <nav className="container mx-auto py-4 px-4 flex items-center justify-between">
                <Link href="/" className="flex items-center space-x-2">
                    <div className="font-bold text-2xl">
                        <span className="text-blue-600">PARAMOUNT</span>{" "}
                ...
                <div className="hidden md:flex items-center space-x-8">
                    ...
                    <Button
                        asChild
                        className="bg-blue-600 hover:bg-blue-700 hover:text-white px-6 py-2.5"
                    >
                    ...
                    <div className="p-4 w-full">
                        ...
                        <div className="mt-6 flex flex-col space-y-4">
                            ...
                            <div className="pt-4">
                                <Button
                                    asChild
                                    className="w-full px-6 py-3 bg-blue-600 hover:bg-blue-700 hover:text-white"
                                >
                                    <Link href="/contact">Get a Quote</Link>
                                </Button>
                            </div>
