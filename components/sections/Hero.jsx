        ...
        <div className="relative min-h-screen flex items-center bg-gradient-to-br from-blue-900 to-slate-900 overflow-hidden">
                    ...
                    <div className="md:w-1/2 text-center md:text-left">
                        ...
                        >
                            ...
                            <p className="text-lg md:text-xl text-slate-300 mb-8 max-w-xl">
                                Paramount Energy Group delivers reliable,
                                innovative electrical services across Greater
                                Sydney and NSW with expertise and integrity.
                            </p>
                            <div className="flex flex-col sm:flex-row justify-center md:justify-start space-y-4 sm:space-y-0 sm:space-x-4">
                                <Button
                                    asChild
                                    size="lg"
                                    className="bg-blue-600 hover:bg-blue-700 hover:text-black px-8 py-3"
                                >
                            ...
                            <div className="relative">
                                ...
                                <div className="absolute -bottom-6 -left-6 bg-white rounded-lg shadow-xl p-4 max-w-[240px]">
                                    ...
                                    <p className="mt-2 text-sm text-slate-600">
                                        Serving Sydney & surrounds with rapid
                                        response times.
                                    </p>
                                </div>
                            </div>
            ...
            <div className="absolute bottom-0 left-0 w-full overflow-hidden">
                <svg
                    ...
                    className="h-16 md:h-24 w-full fill-white"
                >
